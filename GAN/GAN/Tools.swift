...
//  GAN
//
//  Created by John Chen on 16/08/2017.
...
class Tools {
    ...
    init() {
        bitMapInfo = DeviceInformation.simulator ? .floatComponents : .byteOrder16Little
        bitsPerComponent = DeviceInformation.simulator ? 32 : 8
    }
